...
st.title("Termin-AI")
st.subheader("Havalimanı Yolcu Terminali Hizmetlerinin İyileştirilmesine Yönelik")
st.subheader("Yapay Zekâ Tabanlı Karar Destek Sistemi")
st.subheader("Arayüz Prototipi 1.0")
st.caption(
